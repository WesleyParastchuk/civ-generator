  ...
  return (
    <section>
      <div className="flex items-center justify-between gap-4">
        ...
        {!editable && (
          <span className="text-xs text-[rgb(206_189_156_/_0.6)]">somente visualização</span>
        )}
      </div>
        ...
        <article className="game-card rounded-xl border border-[rgb(190_153_81_/_0.35)] bg-[rgb(11_25_44_/_0.72)] p-4 shadow-[inset_0_0_0_1px_rgb(255_220_150_/_0.06)]">
          ...
          <div className="mt-2 flex items-center gap-2">
            {editable ? (
              ...
              <span className="text-xl font-semibold text-[rgb(239_223_187_/_0.98)]">{turns}</span>
            )}
          </div>
          <p className="mt-2 text-sm text-[rgb(206_189_156_/_0.8)]">
            {editable
              ? "Mínimo 1 e máximo 10 turnos."
              : `${turns} ${turnsLabel} configurados.`}
          </p>
        </article>
        ...
        <article className="game-card rounded-xl border border-[rgb(190_153_81_/_0.35)] bg-[rgb(11_25_44_/_0.72)] p-4 shadow-[inset_0_0_0_1px_rgb(255_220_150_/_0.06)]">
          ...
          <div className="mt-2 flex items-center gap-2">
            {editable ? (
              ...
              <span className="text-xl font-semibold text-[rgb(239_223_187_/_0.98)]">
                {pointsPerTurn}
              </span>
            )}
          </div>
          <p className="mt-2 text-sm text-[rgb(206_189_156_/_0.8)]">
            {editable
              ...
              : `${pointsPerTurn} ${pointsLabel} por turno.`}
          </p>
        </article>
      </div>
